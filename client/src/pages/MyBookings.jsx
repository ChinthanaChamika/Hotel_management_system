...
const[bookings,setBooking]=useState(userBookingsDummyData)
    ...
    <div className="py-28 md:pb-35 md:pt-32 px-4 md:px-16 lg:px-24 xl:px-32">
        ...
        <Title title=" My Booking " subTitle="Easily manage your past, currrent , and upcomming hotel reservations in one place. Plan your tipss seamlessly with just a few  clicks" align="left"/>
